...
t1 = Task.new(:t_name => "企画決め", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "幹事1", :parent_task_id => 0, :following_task_id => 0, :t_number => 1, :work_id => 1 , :person_id => 1 )
t2 = Task.new(:t_name => "要望聞き込み", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "幹事2", :parent_task_id => 1, :following_task_id => 1, :t_number => 1, :work_id => 1 , :person_id => 2 )
t3 = Task.new(:t_name => "予算案", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "幹事1", :parent_task_id => 1, :following_task_id => 2, :t_number => 1, :work_id => 1 , :person_id => 1 )
t4 = Task.new(:t_name => "行き先決定", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "幹事1", :parent_task_id => 1, :following_task_id => 3, :t_number => 1, :work_id => 1 , :person_id => 1 )

t1.save!; t2.save!; t3.save!; t4.save!;

t5 = Task.new(:t_name => "詳細決め", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "幹事1", :parent_task_id => 0, :following_task_id => 4, :t_number => 2, :work_id => 1 , :person_id => 1 )
t6 = Task.new(:t_name => "宿泊施設決定", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "飲み会", :parent_task_id => 2, :following_task_id => 5, :t_number => 2, :work_id => 1 , :person_id => 3 )
t7 = Task.new(:t_name => "企画決め", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "飲み会", :parent_task_id => 2, :following_task_id => 6, :t_number => 2, :work_id => 1 , :person_id => 3 )
t8 = Task.new(:t_name => "交通手段決め", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "予算", :parent_task_id => 2, :following_task_id => 7, :t_number => 2, :work_id => 1 , :person_id => 4 )

t5.save!; t6.save!; t7.save!; t8.save!;

t9 = Task.new(:t_name => "企画発表", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "幹事1", :parent_task_id => 0, :following_task_id => 8, :t_number => 3, :work_id => 1 , :person_id => 1 )
t10 = Task.new(:t_name => "参加者決め", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "幹事2", :parent_task_id => 3, :following_task_id => 9, :t_number => 3, :work_id => 1 , :person_id => 2 )
t11 = Task.new(:t_name => "出欠確認", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "飲み会", :parent_task_id => 3, :following_task_id => 10, :t_number => 3, :work_id => 1 , :person_id => 3 )
t12 = Task.new(:t_name => "保険", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "飲み会", :parent_task_id => 3, :following_task_id => 11, :t_number => 3, :work_id => 1 , :person_id => 3 )

t9.save!; t10.save!; t11.save!; t12.save!;

t13 = Task.new(:t_name => "当日スケジュール", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "幹事1", :parent_task_id => 0, :following_task_id => 12, :t_number => 4, :work_id => 1 , :person_id => 1 )
t14 = Task.new(:t_name => "バス", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "幹事1", :parent_task_id => 4, :following_task_id => 13, :t_number => 4, :work_id => 1 , :person_id => 1 )
t15 = Task.new(:t_name => "集金", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "予算", :parent_task_id => 4, :following_task_id => 14, :t_number => 4, :work_id => 1 , :person_id => 4 )
t16 = Task.new(:t_name => "飲み会", :start_date => "2020-03-20", :end_date => "2020-03-25",
         :role => "飲み会", :parent_task_id => 4, :following_task_id => 15, :t_number => 4, :work_id => 1 , :person_id => 4 )
