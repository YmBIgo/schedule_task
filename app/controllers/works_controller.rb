...
class WorksController < ApplicationController
    ...
    def generate_gassyuku_tasks()
        ...
        {"t_name" => "合宿下準備","role" => "幹事1", "parent_task_id" => 0,"before_date" => 80,"date_duration" => 5,"t_number" => 1},
        {"t_name" => "要望聞き込み","role" => "幹事2", "parent_task_id" => 1,"before_date" => 75,"date_duration" => 5,"t_number" => 1},
        {"t_name" => "予算案","role" => "幹事1", "parent_task_id" => 1,"before_date" => 70,"date_duration" => 5,"t_number" => 1},
        {"t_name" => "行き先決定","role" => "幹事1", "parent_task_id" => 1,"before_date" => 70,"date_duration" => 5,"t_number" => 1},
        {"t_name" => "詳細決め","role" => "幹事1", "parent_task_id" => 0,"before_date" => 65,"date_duration" => 10,"t_number" => 2},
        {"t_name" => "宿泊施設決定","role" => "飲み会", "parent_task_id" => 2,"before_date" => 60,"date_duration" => 5,"t_number" => 2},
        ...
        {"t_name" => "企画発表","role" => "幹事1", "parent_task_id" => 0,"before_date" => 30,"date_duration" => 5,"t_number" => 3},
        {"t_name" => "参加者決め","role" => "幹事2", "parent_task_id" => 3,"before_date" => 25,"date_duration" => 5,"t_number" => 3},
        {"t_name" => "出欠確認","role" => "飲み会", "parent_task_id" => 3,"before_date" => 20,"date_duration" => 5,"t_number" => 3},
